...
@endsection
@section('content')
    @include('panels.driver.map')
    @include('panels.driver.income')
    @include('panels.driver.services')
    @include('panels.driver.inbox')
    @include('panels.driver.profile')
    @include('panels.driver.tripDetail')
    @include('panels.driver.wallet')
    @include('panels.driver.profileDetail')
    @include('panels.driver.tripHistory')
@endsection
@section('custom_js')
