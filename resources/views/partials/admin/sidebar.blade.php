...
@if ($user && $user->hasRole('manager'))
    ...
    <div class="sidebar-content p-4 overflow-y-auto custom-scrollbar">
        <div class="space-y-6">
            <div>
                <h1 class="text-sidebar-foreground/70 mb-2 px-2 sidebar-group-label branch-info">
                    {{ $user->branch->name ?? 'N/A' }}
                </h1>
                <h3 class="text-xs font-medium text-sidebar-foreground/70 mb-2 px-2 sidebar-group-label">Menu Chi nhánh
                </h3>
