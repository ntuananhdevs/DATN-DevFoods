...
<div class="sidebar-content p-4 overflow-y-auto custom-scrollbar">
    <div class="space-y-6">
        <div>
            ...
            <!-- Categories -->
            <a href="{{ route('admin.categories.index') }}" class="sidebar-menu-item flex items-center rounded-md p-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground {{ request()->routeIs('admin.categories.*') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium' : '' }} sidebar-tooltip" data-tooltip="Categories">
                <span class="sidebar-icon-container mr-2 flex items-center justify-center">
            ...
            <div class="sidebar-dropdown sidebar-tooltip" data-tooltip="Menu Management">
                <button type="button" class="sidebar-dropdown-trigger flex items-center w-full rounded-md p-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground {{ request()->routeIs('admin.products.*') || request()->routeIs('admin.combo.*') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium' : '' }}">
                    <span class="sidebar-icon-container mr-2 flex items-center justify-center">
            ...
            <!-- Chat -->
            <a href="{{ route('admin.chat') }}" class="sidebar-menu-item flex items-center rounded-md p-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground {{ request()->routeIs('admin.chat.*') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium' : '' }} sidebar-tooltip" data-tooltip="Chat">
                <span class="sidebar-icon-container mr-2 flex items-center justify-center">
            ...
            <div class="sidebar-dropdown sidebar-tooltip" data-tooltip="Drivers">
                ...
                <div class="sidebar-dropdown-content ml-6 pl-2 border-l border-sidebar-border mt-1 space-y-1 hidden">
                    <a href="{{ route('admin.drivers.index') }}" class="flex items-center rounded-md p-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground {{ request()->routeIs('admin.drivers.index') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium' : '' }}">
                        <span class="sidebar-text">Tất cả tài xế</span>
                    </a>
                    <a href="{{ route('admin.drivers.applications.index') }}" class="flex items-center rounded-md p-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground {{ request()->routeIs('admin.drivers.applications.index') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium' : '' }}">
            ...
            <!-- Discount Codes -->
            <a href="{{ route('admin.discount_codes.index') }}" class="sidebar-menu-item flex items-center rounded-md p-2 text-sm hover:bg-sidebar-accent hover:text-sidebar-accent-foreground {{ request()->routeIs('admin.discount_codes.*') ? 'bg-sidebar-accent text-sidebar-accent-foreground font-medium' : '' }} sidebar-tooltip" data-tooltip="Discount Codes">
                <span class="sidebar-icon-container mr-2 flex items-center justify-center">
