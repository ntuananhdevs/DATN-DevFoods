            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button id="statusToggle" class="relative inline-flex h-6 w-11 items-center rounded-full bg-green-500 transition-colors">
                    ...
                    <button class="relative p-2 text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg">
                        ...
                        <span id="notificationBadge" class="absolute -top-1 -right-1 h-5 w-5 bg-red-500 text-white text-xs rounded-full flex items-center justify-center hidden">0</span>
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="w-80 bg-card border-r border-border flex flex-col">
            ...
            <div class="p-4 border-b border-border">
                ...
                <div class="flex gap-2">
                    <select id="filterStatus" class="flex-1 text-sm border border-input rounded-lg px-3 py-1 bg-background text-foreground focus:ring-2 focus:ring-primary">
                        <option value="all">Tất cả</option>
                        <option value="active">Đang hoạt động</option>
                        <option value="waiting">Chờ phản hồi</option>
                        <option value="closed">Đã đóng</option>
                    </select>
                    <button id="refreshChats" class="px-3 py-1 text-muted-foreground hover:text-foreground hover:bg-accent rounded-lg">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div id="noChatSelected" class="flex-1 flex items-center justify-center bg-muted/30">
                <div class="text-center">
                    ...
                    <p class="text-muted-foreground">Chọn một cuộc trò chuyện từ danh sách để bắt đầu hỗ trợ khách hàng</p>
                </div>
            </div>
                    ...
                    <div class="flex items-end gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-3">
                                <button id="attachFileBtn" class="p-2 text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-lg transition-colors">
                                    <i class="fas fa-paperclip"></i>
                                </button>
                                <button id="attachImageBtn" class="p-2 text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-lg transition-colors">
                                    <i class="fas fa-image"></i>
                                </button>
                                <button id="emojiBtn" class="p-2 text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-lg transition-colors">
                                    <i class="fas fa-smile"></i>
                                </button>
                                <button id="templateBtn" class="p-2 text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-lg transition-colors">
                            ...
                            <div class="relative">
                                ...
                                <!-- Emoji Picker -->
                                <div id="emojiPicker" class="absolute bottom-full right-0 mb-2 bg-popover border border-border rounded-lg p-3 shadow-lg z-10 hidden">
                        ...
                        <div class="flex flex-col gap-2">
                            <button id="sendBtn" class="btn btn-primary px-6 py-3 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed" disabled>
    ...
    <div class="modal-content rounded-lg w-full max-w-2xl mx-4 max-h-[80vh] overflow-hidden">
        ...
        <div class="p-6 overflow-y-auto max-h-[60vh]">
            <div class="grid gap-4">
                <div class="template-item p-4 border border-border rounded-lg hover:border-primary cursor-pointer transition-colors">
                    <h4 class="font-medium mb-2 text-foreground">Chào mừng khách hàng</h4>
                    <p class="text-sm text-muted-foreground">Xin chào! Cảm ơn bạn đã liên hệ với FastFood. Tôi có thể giúp gì cho bạn hôm nay?</p>
                </div>
                
                <div class="template-item p-4 border border-border rounded-lg hover:border-primary cursor-pointer transition-colors">
                    <h4 class="font-medium mb-2 text-foreground">Hỏi thông tin đơn hàng</h4>
                    <p class="text-sm text-muted-foreground">Bạn có thể cung cấp mã đơn hàng để tôi kiểm tra thông tin cho bạn không?</p>
                </div>
                
                <div class="template-item p-4 border border-border rounded-lg hover:border-primary cursor-pointer transition-colors">
                    <h4 class="font-medium mb-2 text-foreground">Hướng dẫn đặt hàng</h4>
                    <p class="text-sm text-muted-foreground">Để đặt hàng, bạn có thể truy cập website của chúng tôi hoặc gọi hotline 1900-xxxx. Chúng tôi sẽ giao hàng trong vòng 30 phút.</p>
                </div>
                
                <div class="template-item p-4 border border-border rounded-lg hover:border-primary cursor-pointer transition-colors">
                    <h4 class="font-medium mb-2 text-foreground">Thông tin khuyến mãi</h4>
                    <p class="text-sm text-muted-foreground">Hiện tại chúng tôi có chương trình giảm 20% cho đơn hàng từ 200k và miễn phí giao hàng trong bán kính 5km.</p>
                </div>
                
                <div class="template-item p-4 border border-border rounded-lg hover:border-primary cursor-pointer transition-colors">
                    <h4 class="font-medium mb-2 text-foreground">Hỗ trợ kỹ thuật</h4>
                    <p class="text-sm text-muted-foreground">Nếu bạn gặp vấn đề với ứng dụng, vui lòng thử tắt và mở lại app. Nếu vẫn không được, tôi sẽ chuyển cho bộ phận kỹ thuật.</p>
                </div>
                
                <div class="template-item p-4 border border-border rounded-lg hover:border-primary cursor-pointer transition-colors">
                    <h4 class="font-medium mb-2 text-foreground">Kết thúc hỗ trợ</h4>
                    <p class="text-sm text-muted-foreground">Cảm ơn bạn đã liên hệ với chúng tôi. Nếu có thắc mắc gì khác, đừng ngần ngại liên hệ nhé! Chúc bạn một ngày tốt lành!</p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateStatusDisplay() {
        ...
        if (isAdminOnline) {
            statusToggle.className = 'relative inline-flex h-6 w-11 items-center rounded-full bg-green-500 transition-colors';
            toggle.className = 'inline-block h-4 w-4 transform rounded-full bg-white transition-transform translate-x-6';
            statusText.textContent = 'Online';
            statusText.className = 'text-sm font-medium text-green-600';
        } else {
            statusToggle.className = 'relative inline-flex h-6 w-11 items-center rounded-full bg-gray-300 transition-colors';
    ...
    function createChatListItem(chat) {
        ...
        div.className = `chat-item p-4 border-b border-border hover:bg-accent cursor-pointer transition-colors ${currentChatId === chat.id ? 'active' : ''}`;
