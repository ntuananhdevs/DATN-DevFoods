        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Chỉnh Sửa Combo: {{ $combo->name }}</h3>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('short_description') is-invalid @enderror" 
                                              ...
                                              rows="2" 
                                              placeholder="Nhập mô tả ngắn về combo">{{ old('short_description', $combo->short_description) }}</textarea>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="4" 
                                              placeholder="Nhập mô tả chi tiết về combo">{{ old('description', $combo->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- Upload hình ảnh mới -->
                                <div class="form-group">
                                    <label for="image">{{ $combo->image ? 'Thay đổi hình ảnh' : 'Hình ảnh chính' }}</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" 
                                               ...
                                               name="featured" 
                                               value="1" 
                                               {{ old('featured', $combo->featured) ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="info-box">
                                        <small class="text-muted">
                                            <strong>Ngày tạo:</strong> {{ $combo->created_at->format('d/m/Y H:i') }}<br>
                                            <strong>Cập nhật:</strong> {{ $combo->updated_at->format('d/m/Y H:i') }}
                                        </small>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="row" id="products-selection">
                                                @foreach($products as $product)
                                                    <div class="col-md-4 mb-3">
                                                        <div class="card product-card {{ in_array($product->id, $combo->products->pluck('id')->toArray()) ? 'selected' : '' }}" data-product-id="{{ $product->id }}">
                                                            <div class="card-body p-2">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" 
                                                                           ...
                                                                           name="products[]" 
                                                                           value="{{ $product->id }}"
                                                                           {{ in_array($product->id, old('products', $combo->products->pluck('id')->toArray())) ? 'checked' : '' }}>
