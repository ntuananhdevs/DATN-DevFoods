...
@section('title', 'Thống kê đơn hàng toàn hệ thống')
@section('description', 'Báo cáo tổng quan và chi tiết các đơn hàng trong hệ thống đặt đồ ăn')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 text-lg">Báo cáo tổng quan và chi tiết các đơn hàng trong hệ thống</p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            ...
            <div>
                ...
                <select name="branch_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
