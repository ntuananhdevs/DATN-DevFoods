...
@section('content')
    ...
    <td>
        <div class="data-table-action-buttons">
            <a href="/admin/products/${product.id}" class="data-table-action-btn data-table-tooltip"
                data-tooltip="Xem chi tiết">
                <i class="fas fa-eye"></i>
            </a>
            <a href="/admin/products/${product.id}/edit" class="data-table-action-btn edit data-table-tooltip"
            ...
            <form action="/admin/products/${product.id}" method="POST" class="d-inline">
                @csrf
                @method('DELETE')
                <button type="submit" class="data-table-action-btn delete data-table-tooltip" data-tooltip="Xóa"
    ...
    cells[4].querySelector('.data-table-amount').textContent =
    `${formatCurrency(product.base_price)} đ`;
    ...
    <div class="data-table-notification-icon">
        <i
            class="fas fa-${type === 'success' ? 'check-circle' : type === 'info' ? 'info-circle' : 'exclamation-circle'}"></i>
    </div>
