    ...
    <div class="data-table-card">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="data-table-action-buttons">
                                    <a href="{{ route('admin.categories.show', $category->id) }}" class="data-table-action-btn" data-tooltip="Xem">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="data-table-action-btn edit" data-tooltip="Sửa">
        ...
        <div class="data-table-footer">
            <div class="data-table-pagination-info">
                Hiển thị {{ $categories->firstItem() }} đến {{ $categories->lastItem() }} / tổng số {{ $categories->total() }}
            </div>
