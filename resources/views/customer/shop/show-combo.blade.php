        ...
        <div class="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-4">
                    <button
                        id="add-to-cart-combo"
                        data-combo-id="{{ $combo->id }}"
                        class="w-full sm:flex-1 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-md font-medium transition-colors flex items-center justify-center">
                        <i class="fas fa-shopping-cart h-5 w-5 mr-2"></i>Thêm vào giỏ hàng
                    </button>
                    <button
                        id="buy-now-combo"
                        data-combo-id="{{ $combo->id }}"
                        class="w-full sm:flex-1 border border-gray-300 hover:bg-gray-50 px-6 py-3 rounded-md font-medium transition-colors">
                        Mua ngay
                    </button>
