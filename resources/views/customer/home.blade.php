            ...
            <div class="products-grid">
                <div class="product-card">
                    <div class="product-image">
                        <img src="images/ga-gion.jpg" alt="Gà Giòn Vui Vẻ">
                    </div>
                    <div class="product-info">
                        <h3 class="product-title">Gà Giòn Vui Vẻ (1 miếng)</h3>
                        <p class="product-description">Gà rán giòn thơm ngon, hương vị đặc trưng của DevFood với lớp bột chiên giòn rụm và thịt gà mềm, thơm ngon.</p>
        ...
        <div class="container">
            <div class="delivery-content">
                <div class="delivery-text">
                    ...
                    <p>Đặt hàng DevFood trực tuyến và nhận giao hàng tận nơi nhanh chóng. Thưởng thức món ăn yêu thích của bạn mà không cần rời khỏi nhà!</p>
    ...
    <section class="parallax-section">
        ...
        <div class="container">
            <div class="parallax-content">
                ...
                <p class="parallax-description">Thưởng thức hương vị đặc trưng của DevFood - Nơi mang đến niềm vui và những khoảnh khắc ấm áp cho mọi gia đình Việt Nam.</p>
                <button class="btn btn-yellow">ĐẶT HÀNG NGAY</button>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="order-card">
                <div class="order-content">
                    ...
                    <p class="order-description">Thưởng thức món ăn DevFood yêu thích tại nhà hoặc đặt trước và đến lấy tại cửa hàng.</p>
        ...
        <div class="container">
            <div class="kids-club-content">
                <div class="kids-club-text">
                    ...
                    <p class="kids-club-description">Tham gia DevFood Kids Club ngay hôm nay để nhận được nhiều ưu đãi đặc biệt, quà tặng sinh nhật và các hoạt động thú vị dành riêng cho các bé!</p>
            ...
            <div class="testimonials-carousel">
                <div class="testimonials-container" id="testimonials-container">
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">Gà rán DevFood là món ăn yêu thích của cả gia đình tôi. Thịt gà mềm, lớp vỏ giòn rụm và gia vị đậm đà. Dịch vụ giao hàng nhanh chóng và nhân viên rất thân thiện.</p>
                    </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">Mỳ Ý sốt bò bằm của DevFood rất ngon, sốt đậm đà và thịt bò nhiều. Tôi thường đặt combo gia đình vào cuối tuần và cả nhà đều rất thích.</p>
                    </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-text">Tổ chức sinh nhật cho con tại DevFood là lựa chọn tuyệt vời. Các bé rất thích không gian vui nhộn và đồ ăn ngon. Nhân viên nhiệt tình hỗ trợ từ đầu đến cuối.</p>
                    </div>
                </div>
            ...
            <div class="news-grid">
                <div class="news-card">
                    ...
                    <div class="news-content">
                        ...
                        <p class="news-excerpt">DevFood vừa khai trương cửa hàng thứ 150 tại Việt Nam, đánh dấu cột mốc phát triển mới...</p>
                ...
                <div class="news-card">
                    ...
                    <div class="news-content">
                        ...
                        <p class="news-excerpt">Hương vị mới lạ với lớp phô mai béo ngậy phủ trên miếng gà giòn rụm đã có mặt tại DevFood...</p>
                        <a href="#" class="news-link">Xem thêm</a>
                    </div>
                </div>
                ...
                <div class="news-card">
                    ...
                    <div class="news-content">
                        ...
                        <p class="news-excerpt">Trong tháng 4 này, DevFood mang đến chương trình khuyến mãi đặc biệt dành cho khách hàng...</p>
                        <a href="#" class="news-link">Xem thêm</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="app-content">
                <div class="app-text">
                    ...
                    <p class="app-description">Đặt hàng nhanh chóng, theo dõi đơn hàng dễ dàng và nhận nhiều ưu đãi hấp dẫn khi sử dụng ứng dụng DevFood.</p>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-column">
                    ...
                    <p class="footer-description">DevFood là thương hiệu đồ ăn nhanh nổi tiếng với các món gà giòn, mỳ Ý, burger và nhiều món ăn hấp dẫn khác.</p>
