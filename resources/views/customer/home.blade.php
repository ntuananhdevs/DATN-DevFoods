...
<head>
    ...
    <meta name="description"
          content="Thực đơn DevFood đa dạng và phong phú, có rất nhiều sự lựa chọn cho bạn, gia đình và bạn bè.">
                    ...
                    <nav class="main-menu">
                        <ul class="menu-items">
                            ...
                            <li class="menu-item dropdown">
                                <a href="#" class="dropdown-toggle">VỀ DevFood <i class="fas fa-chevron-down"></i></a>
    ...
    <div class="mobile-menu" id="mobile-menu">
        <div class="container">
            ...
            <ul class="mobile-menu-items">
                <li class="mobile-menu-item"><a href="/">TRANG CHỦ</a></li>
                <li class="mobile-menu-item"><a href="#">VỀ DevFood</a></li>
    ...
    <div class="hero-container">
        <div class="hero-content">
            ...
            <p class="hero-description">
                Khám phá thực đơn đa dạng và phong phú của DevFood, với nhiều lựa chọn cho bạn, gia đình và bạn bè.
            </p>
        ...
        <div class="hero-image">
            <img src="{{asset('images/banner/banner01.png')}}" alt="Hero Image">
        </div>
    </div>
</section>
...
<section class="category-showcase">
    <div class="container">
        ...
        <p class="section-subtitle">KHÁM PHÁ CÁC DANH MỤC MÓN ĂN PHONG PHÚ CỦA DevFood</p>

        <div class="category-grid">
            @foreach($categories->take(4) as $category)
                <div class="category-card">
                    <div class="category-image">
                        <img src="{{ asset($category->image ?? 'images/default-category.jpg') }}"
                             alt="{{ $category->name }}">
                        <div class="category-overlay"></div>
                        <div class="category-info">
                            <h3>{{ $category->name }}</h3>
                            <p>{{ $category->products->count() }} món</p>
                        </div>
                    </div>
                </div>
            @endforeach
...
<section class="featured-products">
    <div class="container">
        ...
        <p class="section-subtitle">KHÁM PHÁ CÁC MÓN ĂN ĐƯỢC YÊU THÍCH NHẤT TẠI DevFood</p>
    ...
    <div class="view-all-container">
        <button class="btn btn-primary">XEM TẤT CẢ SẢN PHẨM</button>
    </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="delivery-content">
            <div class="delivery-text">
                ...
                <p>Đặt hàng DevFood trực tuyến và nhận giao hàng tận nơi nhanh chóng. Thưởng thức món ăn yêu thích của
                    bạn mà không cần rời khỏi nhà!</p>
                <button class="btn btn-yellow">ĐẶT HÀNG NGAY</button>
            </div>
            <div class="delivery-image">
                <img src="images/delivery.png" alt="DevFood Delivery">
...
<section class="menu-section">
    <div class="container">
        ...
        <p class="section-subtitle">KHÁM PHÁ HƯƠNG VỊ ĐẶC TRƯNG CỦA DevFood</p>
        ...
        <div class="menu-categories">
            <div class="menu-category">
                ...
                <div class="menu-category-content">
                    ...
                    <p class="menu-category-description">Gà rán giòn thơm ngon, hương vị đặc trưng của DevFood</p>
...
<section class="parallax-section">
    ...
    <div class="container">
        <div class="parallax-content">
            <h2 class="parallax-title">DevFood VIETNAM</h2>
            <p class="parallax-description">Thưởng thức hương vị đặc trưng của DevFood - Nơi mang đến niềm vui và những
                khoảnh khắc ấm áp cho mọi gia đình Việt Nam.</p>
            <button class="btn btn-yellow">ĐẶT HÀNG NGAY</button>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="order-card">
            <div class="order-content">
                ...
                <p class="order-description">Thưởng thức món ăn DevFood yêu thích tại nhà hoặc đặt trước và đến lấy tại
                    cửa hàng.</p>
            ...
            <div class="order-image">
                <img src="{{ asset('images/banner/QC.png') }}" alt="DevFood Delivery">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="kids-club-content">
            <div class="kids-club-text">
                <h2 class="kids-club-title">DevFood KIDS CLUB</h2>
                <p class="kids-club-description">Tham gia DevFood Kids Club ngay hôm nay để nhận được nhiều ưu đãi đặc
                    biệt, quà tặng sinh nhật và các hoạt động thú vị dành riêng cho các bé!</p>
            ...
            <div class="kids-club-image">
                <img src="{{ asset('images/banner/kidclub.png') }}" alt="DevFood Kids Club">
                {{-- <div class="rotating-star">
                    <img src="images/star.png" alt="DevFood Star">
                </div> --}}
            </div>
        </div>
    </div>
...
<section class="testimonials-section">
    <div class="container">
        ...
        <p class="section-subtitle">NHỮNG TRẢI NGHIỆM TUYỆT VỜI TỪ KHÁCH HÀNG CỦA DevFood</p>
        ...
        <div class="testimonials-carousel">
            <div class="testimonials-container" id="testimonials-container">
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">Gà rán DevFood là món ăn yêu thích của cả gia đình tôi. Thịt gà mềm, lớp
                        vỏ giòn rụm và gia vị đậm đà. Dịch vụ giao hàng nhanh chóng và nhân viên rất thân thiện.</p>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">Mỳ Ý sốt bò bằm của DevFood rất ngon, sốt đậm đà và thịt bò nhiều. Tôi
                        thường đặt combo gia đình vào cuối tuần và cả nhà đều rất thích.</p>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">Tổ chức sinh nhật cho con tại DevFood là lựa chọn tuyệt vời. Các bé rất
                        thích không gian vui nhộn và đồ ăn ngon. Nhân viên nhiệt tình hỗ trợ từ đầu đến cuối.</p>
                </div>
            </div>
...
<section class="news-section">
    <div class="container">
        ...
        <p class="section-subtitle">CẬP NHẬT THÔNG TIN MỚI NHẤT TỪ DevFood</p>

        <div class="news-grid">
            <div class="news-card">
                <div class="news-image">
                    <img src="images/news-1.jpg" alt="DevFood khai trương cửa hàng mới tại Hà Nội">
                </div>
                <div class="news-content">
                    <div class="news-date">15/04/2024</div>
                    <h3 class="news-title">DevFood khai trương cửa hàng mới tại Hà Nội</h3>
                    <p class="news-excerpt">DevFood vừa khai trương cửa hàng thứ 150 tại Việt Nam, đánh dấu cột mốc phát
                        triển mới...</p>
            ...
            <div class="news-card">
                <div class="news-image">
                    <img src="images/news-2.jpg" alt="Món mới: Gà Sốt Phô Mai đã có mặt tại DevFood">
                </div>
                <div class="news-content">
                    <div class="news-date">10/04/2024</div>
                    <h3 class="news-title">Món mới: Gà Sốt Phô Mai đã có mặt tại DevFood</h3>
                    <p class="news-excerpt">Hương vị mới lạ với lớp phô mai béo ngậy phủ trên miếng gà giòn rụm đã có
                        mặt tại DevFood...</p>
                    <a href="#" class="news-link">Xem thêm</a>
                </div>
            </div>
            ...
            <div class="news-card">
                ...
                <div class="news-content">
                    ...
                    <p class="news-excerpt">Trong tháng 4 này, DevFood mang đến chương trình khuyến mãi đặc biệt dành
                        cho khách hàng...</p>
                    <a href="#" class="news-link">Xem thêm</a>
                </div>
            </div>
...
<section class="store-locator">
    <div class="container">
        ...
        <p class="section-subtitle">TÌM CỬA HÀNG DevFood GẦN BẠN NHẤT</p>
...
<section class="app-download">
    <div class="container">
        <div class="app-content">
            <div class="app-text">
                <h2 class="app-title">TẢI ỨNG DỤNG DevFood</h2>
                <p class="app-description">Đặt hàng nhanh chóng, theo dõi đơn hàng dễ dàng và nhận nhiều ưu đãi hấp dẫn
                    khi sử dụng ứng dụng DevFood.</p>
                <div class="app-buttons">
                    <a href="#" class="app-button">
                        <img src="{{ asset('images/banner/appstore') }}" alt="Download on App Store">
                    </a>
                    <a href="#" class="app-button">
            ...
            <div class="app-image">
                <img src="{{ asset('images/banner/appstore.png') }}" alt="DevFood Mobile App">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="footer-content">
            <div class="footer-column">
                ...
                <p class="footer-description">DevFood là thương hiệu đồ ăn nhanh nổi tiếng với các món gà giòn, mỳ Ý,
                    burger và nhiều món ăn hấp dẫn khác.</p>
            ...
            <div class="footer-column">
                ...
                <ul class="contact-info">
                    ...
                    <li>Địa chỉ: Tầng 26, Tòa nhà CII Tower, 152 Điện Biên Phủ, Phường 25, Quận Bình Thạnh, TP. Hồ Chí
                        Minh
                    </li>
                </ul>
            </div>
