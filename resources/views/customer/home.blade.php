    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <section class="py-10">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <a href="/products?category=burgers"
                    ...
                    <div class="relative w-24 h-24 mb-3 rounded-full overflow-hidden border-2 border-orange-500 p-1">
                        <div class="w-full h-full rounded-full overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=200" alt="Burger"
                ...
                <a href="/products?category=chicken"
                    ...
                    <div class="relative w-24 h-24 mb-3 rounded-full overflow-hidden border-2 border-orange-500 p-1">
                        <div class="w-full h-full rounded-full overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=200" alt="Gà Rán"
                                class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        </div>
                    </div>
                ...
                <a href="/products?category=rice"
                    ...
                    <div class="relative w-24 h-24 mb-3 rounded-full overflow-hidden border-2 border-orange-500 p-1">
                        <div class="w-full h-full rounded-full overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=200" alt="Cơm"
                                class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        </div>
                    </div>
                    <h3 class="font-medium text-sm">Cơm</h3>
                </a>
                <a href="/products?category=noodles"
                    class="group flex flex-col items-center text-center transition-transform hover:scale-105">
                    <div class="relative w-24 h-24 mb-3 rounded-full overflow-hidden border-2 border-orange-500 p-1">
                        <div class="w-full h-full rounded-full overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=200" alt="Mì"
                                class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        </div>
                    </div>
                ...
                <a href="/products?category=drinks"
                    ...
                    <div class="relative w-24 h-24 mb-3 rounded-full overflow-hidden border-2 border-orange-500 p-1">
                        <div class="w-full h-full rounded-full overflow-hidden">
                            <img src="/placeholder.svg?height=200&width=200" alt="Đồ Uống"
                                class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                ...
                <div class="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                    <a href="/products/burger-classic" class="block relative h-48 overflow-hidden">
                        <img src="/placeholder.svg?height=400&width=400" alt="Burger Bò Cổ Điển"
                            class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        <span
                            class="absolute top-2 right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full">Mới</span>
                    </a>
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-500 text-sm mb-3 line-clamp-2">Burger bò với phô mai, rau xà lách, cà chua và
                            sốt đặc biệt</p>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button
                                class="bg-orange-500 hover:bg-orange-600 text-white px-3 py-1 rounded-md text-sm flex items-center transition-colors">
                ...
                <div class="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                    <a href="/products/burger-cheese" class="block relative h-48 overflow-hidden">
                        <img src="/placeholder.svg?height=400&width=400" alt="Burger Phô Mai Đặc Biệt"
                            class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        <span
                            class="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded-full">-10%</span>
                    </a>
                ...
                <div class="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                    <a href="/products/chicken-fried" class="block relative h-48 overflow-hidden">
                        <img src="/placeholder.svg?height=400&width=400" alt="Gà Rán Giòn Cay"
                            class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        <span
                            class="absolute top-2 right-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full">Mới</span>
                    </a>
                    ...
                    <div class="p-4">
                        ...
                        <p class="text-gray-500 text-sm mb-3 line-clamp-2">Gà rán với lớp vỏ giòn và gia vị cay đặc biệt
                        </p>
                ...
                <div class="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                    <a href="/products/pizza-seafood" class="block relative h-48 overflow-hidden">
                        <img src="/placeholder.svg?height=400&width=400" alt="Pizza Hải Sản Đặc Biệt"
                            class="object-cover w-full h-full group-hover:scale-110 transition-transform duration-300">
                        <span
                            class="absolute top-2 left-2 bg-red-500 text-white text-xs px-2 py-1 rounded-full">-15%</span>
                    </a>
        ...
        >>>>>>> 3bf52d76fc92f9d0e6102e3ced231801b6709d68
