...
<style>
    ...
    * {
    ...
    .btn-primary:hover {
        background-color: var(--jollibee-dark-yellow);
    }
    ...
    /* Top Navigation */
    .top-nav {
        background: linear-gradient(to right, var(--jollibee-yellow), var(--jollibee-dark-yellow));
        padding: 0.5rem 0;
    }
        ...
        <div class="main-nav">
            <div class="container">
                <div class="main-nav-content">
                    <div class="logo">
                        <a href="index.html">
                            <img src="images/logo.png" alt="Jollibee Logo">
                        </a>
                    </div>
                    <nav class="desktop-menu">
                        <ul class="nav-list">
                            <li class="nav-item active"><a href="index.html">TRANG CHỦ</a></li>
            ...
            <div class="footer-content">
                <div class="footer-column">
                    <div class="footer-logo">
                        <img src="images/logo-white.png" alt="Jollibee Logo">
                    </div>
