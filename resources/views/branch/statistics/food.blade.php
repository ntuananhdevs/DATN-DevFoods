...
@section('description', 'Báo cáo tổng quan và chi tiết các món ăn tại chi nhánh')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 text-lg">Báo cáo tổng quan và chi tiết các món ăn tại chi nhánh</p>
            </div>
